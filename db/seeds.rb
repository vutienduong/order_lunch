...
# Examples:
#
#   cities = City.edit([{ name: 'Chicago' }, { name: 'Copenhagen' }])
#   Mayor.edit(name: 'Emanuel', city: cities.first)

=begin
restaurants = Restaurant.edit([{name: 'sukiya', address: 'Ho Chi Minh City'}, {name: 'bento taiwan', address: 'Ho Chi Minh city'}])
